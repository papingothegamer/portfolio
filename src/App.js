     ...
     <nav className="w-full px-6 z-50 fixed inset-x-0 top-2 flex justify-center items-center">
      <div className="w-full md:w880 bg-navBar p-4 rounded-2xl flex items-center">
        ...
        {isActive && (
           ...
           href="https://drive.google.com/file/d/1niv9F1D4oN0LQKecwT6VQrkC7l8EhAZ0/view?usp=drive_link" className=" text-base text-textBase font-medium hover:text-slate-100 cursor-pointer border border-textBase px-2 py-1 rounded-xl hover: border-gray-100 duration-100 ease-in-out "
           onClick={() => setIsActive(false)}
           > Download
           </motion.a>
        </motion.div>
